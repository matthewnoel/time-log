...
var app = (function () {
	...
	*/
	...
	var root$2 = add_locations(from_html(`<div role="status"><div><!></div> <!> <progress class="_toastBar svelte-1irx82o"></progress></div>`), ToastItem[FILENAME], [[87, 0, [[96, 2], [114, 2]]]]);
	...
	var root$1 = add_locations(from_html(`<ul class="_toastContainer svelte-1dwp7pi"></ul>`), SvelteToast[FILENAME], [[25, 0]]);
	...
	const getActivityData = (storage = window.localStorage) => {
	    ...
	    for (let i = 0; i < storage.length; i++) {
	        ...
	        if (key == null || key === LEGACY_THEME_STORAGE_KEY)
	            continue;
	...
	const clearActivityData = (storage = window.localStorage) => {
	    storage.clear();
	};

	App[FILENAME] = 'src/App.svelte';

	var root_1 = add_locations(from_html(`<input type="button" value="Ibid" class="svelte-1n46o8q"/>`), App[FILENAME], [[78, 16]]);
	...
	var root_2 = add_locations(from_html(`<h2 class="svelte-1n46o8q">Latest Log</h2> <table class="svelte-1n46o8q"><thead><tr><th colspan="1">Log Time</th><th colspan="1">Duration</th><th colspan="1">Activity</th></tr></thead><tbody><tr><td> </td><td> </td><td> </td></tr></tbody></table>`, 1), App[FILENAME], [
		...
		[
			...
			4,
			[
				[92, 8, [[93, 12, [[94, 16], [95, 16], [96, 16]]]]],
				[99, 8, [[100, 12, [[101, 16], [102, 16], [103, 16]]]]]
			]
		]
	]);

	var root_4 = add_locations(from_html(`<tr><td> </td><td> </td><td> </td></tr>`), App[FILENAME], [[120, 16, [[121, 20], [122, 20], [123, 20]]]]);
	...
	var root_3 = add_locations(from_html(`<h2 class="svelte-1n46o8q">Full Summary</h2> <table class="svelte-1n46o8q"><thead><tr><th colspan="1">Log Time</th><th colspan="1">Duration</th><th colspan="1">Activity</th></tr></thead><tbody></tbody></table> <input type="button" value="New Day" class="svelte-1n46o8q"/>`, 1), App[FILENAME], [
		...
		[
			...
			4,
			[
				[111, 8, [[112, 12, [[113, 16], [114, 16], [115, 16]]]]],
				[118, 8]
			]
		],
		[128, 4]
		...
		[
			...
			[
				[
					62,
					4,
					[[63, 8, [[64, 12], [65, 12], [66, 12]]], [76, 8, [[85, 12]]]]
				]
			]
		],
		[138, 0, [[139, 4], [142, 4]]]
	...
	function App($$anchor, $$props) {
		...
		add_svelte_meta(() => SvelteToast(node, {}), 'component', App, 59, 0, { componentTag: 'SvelteToast' });
